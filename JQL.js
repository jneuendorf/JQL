...
(function() {
  var JQL, arrEquals, cloneObject, getSelf, loadingTime, records, schema, start, table, toArr,
    slice = [].slice,
  ...
  JQL.Table = (function() {
    ...
    Table["new"].fromJSON = function(json, name) {
      var col, len, len1, m, o, r, record, records, ref, schema, table;
  ...
  window.test = function() {
    var colJql, end, jql, jql2, start, t1, t2, t3;
    this.json = [
      {
        id: 0,
        a: 10,
  ...
  describe("JQL.Table", function() {
    it("constructor", function() {
      ...
      expect(table.name).toBe("bigTable");
      colJson = [
        {
          name: "col1",
          type: "testType",
