...
(function() {
  var JQL, arrEquals, cloneObject, getSelf, loadingTime, padNum, records, schema, start, table, toArr,
    slice = [].slice,
  ...
  JQL.Table = (function() {
    ...
    function Table(schema, records, name, partOf) {
      var col, cols, i, key, len1, len2, m, o, pseudoRecord, type, val;
      if (name == null) {
        name = "Table";
      }
      if (partOf == null) {
    ...
    Table.prototype.innerJoin = function(table, leftCol, rightCol) {
      var leftRecord, leftSchema, len1, len2, m, o, records, ref1, ref2, rightRecord, rightSchema;
      if (!rightCol) {
        rightCol = leftCol;
      }
      records = [];
    ...
    Table.prototype.leftJoin = function(table, leftCol, rightCol) {
      var i, leftRecord, leftSchema, len1, len2, m, matchFound, nullArray, o, records, ref1, ref2, rightRecord, rightSchema;
      if (!rightCol) {
        rightCol = leftCol;
      }
      records = [];
    ...
    Table.prototype["delete"] = function(param) {
      var child, childRecord, i, incidesToRemove, len1, len2, m, o, record, ref1, ref2, ref3;
      if (param instanceof JQL.Table) {
        ...
        this.records = (function() {
          ...
          ref3 = this.records;
          results = [];
          for (i = p = 0, len3 = ref3.length; p < len3; i = ++p) {
            record = ref3[i];
    ...
    Table.prototype.each2 = function(callback) {
      var col, i, j, len1, len2, m, o, r, record, ref1, ref2;
      ref1 = this.records;
      for (i = m = 0, len1 = ref1.length; m < len1; i = ++m) {
        record = ref1[i];
        r = {};
    ...
    Table.prototype.toJSON = function() {
      var col, i, len1, len2, m, map, o, obj, record, ref1, ref2, res;
      res = [];
  ...
  describe("miscellaneous", function() {
    ...
    return it("padNum", function() {
      ...
      return expect(padNum(333, 5)).toBe("00333");
    });
  });
